...
const addsubject=require('./routes/subject_teacher_add(adminpart)/subject_route');
const addteacher=require('./routes/subject_teacher_add(adminpart)/teacher_route');
